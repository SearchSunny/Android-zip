	...
	private OnClickListener onClickListener = new OnClickListener(){
		...
		public void onClick(View v) {
			...
			case R.id.btn_zip:
				...
				try {
					//测试数据，注意更换目录
					LinkedList<File> files = DirTraversal.listLinkedFiles(pathString+"/Android/data/com.info.collection/files/cache");
					
					File file = DirTraversal.getFilePath(pathString+"/Android/data/com.info.collection/files/", "cache.zip");
			...
			case R.id.btn_unzip:
				File file = DirTraversal.getFilePath(pathString+"/Android/data/com.info.collection/files/", "cache.zip");
				try {
					ZipUtils.upZipFile(file, pathString+"/Android/data/com.info.collection/files/cachezip");
